 ...
 * Allows access to a proverb for use in a game that allows people to 
 ...
 */
 public class Proverb {
	...
	/**
	 * Initializes all fields from parameters.
	 * 
	 * @param fullText Initial value for {@link #fullText}
	 * @param puzzleText Initial value for {@link #puzzleText}
	 ...
	 * 
	 * @return prompt of the form, "There is an old (origin) proverb: " +start of proverb + "...".
	 */
