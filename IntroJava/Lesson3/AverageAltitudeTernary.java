...
public class AverageAltitudeTernary {
    public static void main(String[] args) {
        ...
        hasNonPositiveValue = altitude1 <= 0 ? true : hasNonPositiveValue;
        ...
        hasNonPositiveValue = altitude2 <= 0 ? true : hasNonPositiveValue;
        ...
        hasNonPositiveValue = altitude3 <= 0 ? true : hasNonPositiveValue;
