 ...
 *
 */
public class MoonWeightCalculatorTernary {
	...
	public static void main(String[] args) {
		...
		System.out.println("and any other number if you want your weight calculated on Mars.");
		System.out.print("The moon? (1) or Mars? (Any other number): ");
		...
		System.out.printf("Your weight on %s is %.1f.\n",
				choice == 1 ? "the moon" : "Mars",
				celestialWeight);
	}
