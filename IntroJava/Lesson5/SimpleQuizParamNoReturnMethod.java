...
public class SimpleQuizParamNoReturnMethod {
	
	public static void poseQuestion(String question, String answerA, 
	...
	public static void main(String[] args) {
		...
		while (answer != 'c') {
			...
			poseQuestion("What is the complement of 400 <= co2Reading && co2Reading <= 800?",
