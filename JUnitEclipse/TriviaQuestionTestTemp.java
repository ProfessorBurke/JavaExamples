...
class TriviaQuestionTestTemp {
	...
	String[] NEW_ANSWERS = {"Charles Babbage", "Ada Lovelace", "Grace Hopper", "Edward Djikstra"};
	...
	void testUnposedCanBeMutated() {
		...
		// Answer the question and confirm points and correct answer have been mutated
