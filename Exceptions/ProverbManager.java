...
public class ProverbManager {
	 ...
	 * @param path
	 * @return
	 * @throws FileNotFoundException Thrown if the Proverbs file cannot be found in the passed directory.
	 */
...
//		}
	...
	public ProverbManager()   {
		this.proverbs = new ArrayList<Proverb>();
		this.proverbs.add(new Proverb("","",""));
		this.proverbs.add(new Proverb("","",""));
		this.proverbs.add(new Proverb("","",""));
		this.currentProverb = 0;
	}
